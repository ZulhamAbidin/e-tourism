            ...
            <div class="col-xl-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Menu Utama {{ $destinasiKuliner->MenuKuliner }}</p>
                        <p class="card-text">Jam Buka : {{ $destinasiKuliner->JamBuka }}</p>
                        <p class="text-justify"> Deskripsi : {{ $destinasiKuliner->Deskripsi }}</p>
