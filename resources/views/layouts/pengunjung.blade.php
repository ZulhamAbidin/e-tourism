...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="{{ asset('assets/images/brand/logo-2.png') }}"
                    alt="..." /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('pengunjung.destinasi.index') }}">Wisata</a>
                    </li>
                    <li class="nav-item"><a class="nav-link"
                            href="{{ route('pengunjung.kebudayaan.index') }}">Budaya</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('pengunjung.kuliner.index') }}">Kuliner</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('pengunjung.hotel.index') }}">Penginapan</a>
                    </li>
                    @if (Auth::check())
